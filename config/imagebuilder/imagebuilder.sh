...
rebuild_firmware() {
    ...
    my_packages="\
        base-files blkid block-mount btrfs-progs busybox cgi-io curl e2fsprogs \
        ...
        luci-app-amlogic luci-i18n-amlogic-zh-cn firewall4 luci-app-firewall luci-i18n-firewall-zh-cn \
        luci-app-package-manager luci-i18n-package-manager-zh-cn luci-theme-argon \
        "
